...
// Sinusoid.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSinusoidApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSinusoidApp::OnAppAbout)
...
// Создание CSinusoidApp

CSinusoidApp::CSinusoidApp() noexcept
{
	...
	SetAppID(_T("Sinusoid.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSinusoidApp

CSinusoidApp theApp;


// Инициализация CSinusoidApp
...
// Обработчики сообщений CSinusoidApp
